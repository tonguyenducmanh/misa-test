...
export default function TruongChonNhieu({arr, value}) {
        ...
        useEffect(()=>{
            ...
            for(let z = 0 ; z <thongTinInputBox.length; z++){
                thongTinInputBox[z].addEventListener('click', thongTinListEvent)
            }
            return()=>{
                for(let z = 0 ; z <thongTinInputBox.length; z++){
                    thongTinInputBox[z].removeEventListener('click', thongTinListEvent)
                }
            }
        },[thongTinInputBox])
