...
{
    public class PostCustomerAllQuery
    {
        public string query([FromForm] PostSearchAndFilter PostSearchAndFilter)
        {
            ...
            string limit = $" LIMIT {PostSearchAndFilter.limit}";
            string startIndex = $" OFFSET {PostSearchAndFilter.startIndex}";
            stringCustomerAllQuery += limit;
            stringCustomerAllQuery += startIndex;
